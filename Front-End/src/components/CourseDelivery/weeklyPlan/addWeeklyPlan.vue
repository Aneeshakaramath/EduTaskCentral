<template>
    ...
    <div class="col boldText">
        ...
        <div class="form-group boldText">
            <input id="form1Example2" class="form-control boldText" v-model="moduleNumber" disabled />
            <label class="form-label boldText" for="form1Example2">Module Number</label>
        </div>

        <!-- Module Name Input -->
        <div class="form-group">
            <input id="form1Example2" class="form-control boldText" v-model="moduleName" disabled />
        ...
        <!-- Total DaysInput -->
        <div class="form-group">
            <input id="form1Example2" class="form-control boldText" v-model="noOfClassesRequired" disabled />
            <label class="form-label boldText" for="form1Example2">Total days required</label>
        </div>

        <!-- Start date Input -->
        <div class="form-group">
            <label for="end-date" class="boldText">Start Date</label>
            <input class="date-input boldText" type="date" id="end-date" name="end-date" v-model="startDate">
        </div>
        ...
        <div>
            <label class="typo__label boldText">Select class Days</label>
            <VueMultiselect
        ...
        <div class="btn-container boldText">
